...
public class MetadataDaoImpl implements MetadataDao {
	...
	private String selectMetadataSql(String[] tables) {
		...
		if (DbUtils.isMysql()) {
			return selectMetadataSqlByMysql(tables);
		}
		return null;
	}
	...
	private String selectMetadataSqlByMysql(String[] tables) {
		StringBuffer sql = new StringBuffer();
		sql.append(" select m.TABLE_SCHEMA as schemaName,\n" +
				"m.TABLE_NAME as tableName,\n" +
				"m.COLUMN_NAME as columnName,\n" +
				"cast(m.COLUMN_TYPE as char) as columnType,\n" +
				"m.COLUMN_COMMENT as comments,\n" +
				"m.CHARACTER_MAXIMUM_LENGTH as dataLength,\n" +
				"m.NUMERIC_PRECISION as dataPrecision,\n" +
				"m.NUMERIC_SCALE as dataScale,\n" +
				"m.IS_NULLABLE as nullable," +
				"m.COLUMN_KEY as columnKey" +
	...
	private String selectMetadataSqlByMysql2(String table) {
		StringBuffer sql = new StringBuffer();
